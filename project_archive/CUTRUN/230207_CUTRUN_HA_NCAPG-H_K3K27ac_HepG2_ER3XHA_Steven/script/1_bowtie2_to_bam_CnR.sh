...
# Last modified time: 2023-07-24

# Set parameters and directories
HOME="/mnt/home/digan"
BASE="${HOME}/seq/CUTRUN/230207_CUTRUN_HA_NCAPG-H_K3K27ac_HepG2_ER3XHA_Steven"
...
COMMENT
  ...
  nice $DEEPTOOLS/bamCoverage -b $output_sorted_bam -o $output_bw -bs $BINSIZE \
    --effectiveGenomeSize $GENOMESIZE --normalizeUsing $NORMALIZE --ignoreForNormalization $IGNORE --ignoreDuplicates
