...
# Last modified time: 2023-05-10

# Set parameters and directories
HOME="/mnt/home/digan"
BASE="${HOME}/seq/PROseq/151113_PRO_MCF7_Steven"
...
for R1 in $INPUT_DIR/*trimmed.fq.gz; do
...
#  R2="${R1%_R1_val_1_val_1.fq.gz}_R2_val_2_val_2.fq.gz"
  ...
  sample_name=$(basename "$R1" _R1_trimmed.fq.gz)
  ...
  output_bw="${OUTPUT_DIR}/track/${sample_name}_${NORMALIZE}.bw"
...
<<COMMENT
  ...
  nice $BOWTIE2 -x $GENOME_INDEX -U $R1 --very-sensitive -p $CPU -S $output_sam 2> $log_file
