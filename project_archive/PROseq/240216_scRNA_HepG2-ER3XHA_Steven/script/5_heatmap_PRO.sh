...
# Last modified time: 2023-05-15

# Set directories
HOME="/mnt/home/digan"
BASE="${HOME}/work/seq/PROseq/240216_scRNA_HepG2-ER3XHA_Steven"
...
BODY_LENGTH=7500
BIN_SIZE=10
GENOME_BED="${HOME}/work/ref/annot/hg19/hg19_annot_genome.bed"
CPU=8
COLOR="RdBu"
SORT="descend"
Z=10
...
for mtx_name in "${mtx_names[@]}"; do
  ...
  nice $DEEPTOOLS/plotHeatmap -m $mtx_file -out $plot_out --colorMap $COLOR \
    --zMin -$Z --zMax $Z --missingDataColor 1 $REGIONSLABEL --sortRegions $SORT
