...
# Last modified time: 2023-07-06

# Set parameters and directories
HOME="/mnt/home/digan"
BASE="${HOME}/seq/PROseq/230222_230321_PRO_HepG2-ER3XHA_MCF7_Steven"
INPUT_DIR="${BASE}/cleandata2"
...
for R1 in $INPUT_DIR/*_R1_val_1_val_1.fq.gz; do
  ...
  sample_name=$(basename "$R1" _R1_val_1_val_1.fq.gz)
