...
Shared figure helpers, promoted from the Ren/Reed multiome analyses (~30 style
...
- **`_figure_style.py`** — `apply_publication_style()` sets the lab's canonical
  ...
  (font 13/11, dpi 200) exists in Reed `[redacted]_dar_deg_v2`; reconcile there if
  you switch the house style.
